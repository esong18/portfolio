    ...
    <section className="px-6 md:px-12 py-10 md:py-14 max-w-6xl mx-auto">
      ...
      <div>
        <div className="max-w-2xl">
          ...
          <div className="space-y-4">
            <p className="text-base text-foreground/80 leading-relaxed">
              You can find me eating my way through the city, spending my evening as a hobbyist nail artist, or outside the city exploring mother nature&apos;s backyard. Occasionally I&apos;ll play an aggressively average game of basketball or turn everyday life into video diaries.
            </p>
            <p className="text-base text-foreground/80 leading-relaxed">
